...
class PairwiseAlignment():
    ...
    def get_score_and_actions_from_dp(self, dna_sequence_1, dna_sequence_2):
        ...
        # If it is not at the base case, do the following
            ...
            # Calculate the values of the deletion, insertion, and match actions by adding the penalty or sigma value
            ...
            # JK: Need to find a better way to discriminate between actions with equal score
            # Use the previous actions list from the current maximum action and add the maximum action to the running list
            max_prev_actions = action_values[max_actions[0]][1]
            max_prev_actions.append(max_actions[0])
    ...
    def compute_sigma(self, l1, l2):
        ...
        # Find the indexes of the letters within the indexing set
        index_l1 = indexing[l1]
        index_l2 = indexing[l2]
        
        # Obtain sigma using the indexes from above to find the corresponding value in the sigma array
