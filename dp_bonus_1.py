...
class PairwiseAlignment:
    ...
    def get_score_and_actions_from_dp(self, dna_sequence_1, dna_sequence_2):
        ...
        if dna_size_1 == 0 or dna_size_2 == 0:
            ...
            # This also handles the case where both DNA sequences have length 0
            base_case_score = 0
            actions = []
        ...
        # If it is not at the base case, do the following
            ...
            recursive_match, match_prev_actions = self.get_score_and_actions_from_dp(
            ...
            for k in range(dna_size_2):
                ...
                recursive_insertion, insertion_prev_actions = self.get_score_and_actions_from_dp(
                    dna_sequence_1, recursive_dna_sequence_2
                )
            ...
            for k in range(dna_size_1):
                ...
                recursive_deletion, deletion_prev_actions = self.get_score_and_actions_from_dp(
                    recursive_dna_sequence_1, dna_sequence_2
                )
            ...
            action_values = {
                "deletion": [max_deletion_score, max_deletion_prev_actions],
                "insertion": [max_insertion_score, max_insertion_prev_actions],
                "match": [match, match_prev_actions],
            }
